...
import p455w0rd.morphtweaks.api.ITOPEntityInfoProvider;
import p455w0rd.morphtweaks.api.ITOPInfoProvider;
...
public class TOP {
	...
	public static void init() {
		...
		registered = true;
		FMLInterModComms.sendFunctionMessage("theoneprobe", "getTheOneProbe", "p455w0rd.morphtweaks.integration.TOP$GetTheOneProbe");
	}
	...
	public static class GetTheOneProbe implements com.google.common.base.Function<ITheOneProbe, Void> {
		...
		public Void apply(ITheOneProbe theOneProbe) {
			...
			probe.registerBlockDisplayOverride((mode, probeInfo, player, world, blockState, data) -> {
				...
				else if (blockState != null && blockState.getBlock() instanceof ITOPBlockDisplayOverride) {
					ITOPBlockDisplayOverride provider = (ITOPBlockDisplayOverride) blockState.getBlock();
					return provider.overrideStandardInfo(mode, probeInfo, player, world, blockState, data);
				}
				return false;
			});
