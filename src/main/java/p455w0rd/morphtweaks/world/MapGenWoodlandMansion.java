 ...
 *
 */
public class MapGenWoodlandMansion extends MapGenStructure {
	...
	private final ChunkGeneratorMorphCraft provider;

	public MapGenWoodlandMansion(ChunkGeneratorMorphCraft providerIn) {
		provider = providerIn;
	}
	...
	protected StructureStart getStructureStart(int chunkX, int chunkZ) {
		return new MapGenWoodlandMansion.Start(world, provider, rand, chunkX, chunkZ);
	}
	...
	public static class Start extends StructureStart {
		...
		public Start(World p_i47235_1_, ChunkGeneratorMorphCraft p_i47235_2_, Random p_i47235_3_, int p_i47235_4_, int p_i47235_5_) {
			super(p_i47235_4_, p_i47235_5_);
			create(p_i47235_1_, p_i47235_2_, p_i47235_3_, p_i47235_4_, p_i47235_5_);
		}

		private void create(World p_191092_1_, ChunkGeneratorMorphCraft p_191092_2_, Random p_191092_3_, int p_191092_4_, int p_191092_5_) {
